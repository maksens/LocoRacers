    ...
    private void WriteRaceFinishOrder(int race, BaseCar b)
    {
        switch (race)
        {
            case 1:
                ...
                if (!m_winnerHasBeenDeclared)
                {
                    raceStat.FirstPosition = b.CarName;
                ...
                else if (!m_secondHasBeenDeclared)
                {
                    ...
                    raceStat.SecondPosition = b.CarName;
                    raceStat.SecondPositionTimer = b.m_raceTime;
                }
                else if (!m_thirdHasBeenDeclared)
                {
                    raceStat.ThirdPosition = b.CarName;
                    raceStat.ThirdPositionTimer = b.m_raceTime;
                }
                else if (!m_fourthHasBeenDeclared)
                {
                    raceStat.FourthPosition = b.CarName;
            ...
            case 2:
                ...
                if (!m_winnerHasBeenDeclared)
                {
                    raceStat2.FirstPosition = b.CarName;
                ...
                else if (!m_secondHasBeenDeclared)
                {
                    ...
                    raceStat2.SecondPosition = b.CarName;
                    raceStat2.SecondPositionTimer = b.m_raceTime;
                }
                else if (!m_thirdHasBeenDeclared)
                {
                    raceStat2.ThirdPosition = b.CarName;
                    raceStat2.ThirdPositionTimer = b.m_raceTime;
                }
                else if (!m_fourthHasBeenDeclared)
                {
                    raceStat2.FourthPosition = b.CarName;
            ...
            case 3:
                ...
                if (!m_winnerHasBeenDeclared)
                {
                    raceStat3.FirstPosition = b.CarName;
                ...
                else if (!m_secondHasBeenDeclared)
                {
                    ...
                    raceStat3.SecondPosition = b.CarName;
                    raceStat3.SecondPositionTimer = b.m_raceTime;
                }
                else if (!m_thirdHasBeenDeclared)
                {
                    raceStat3.ThirdPosition = b.CarName;
                    raceStat3.ThirdPositionTimer = b.m_raceTime;
                }
                else if (!m_fourthHasBeenDeclared)
                {
                    raceStat3.FourthPosition = b.CarName;
            ...
            case 4:
                ...
                if (!m_winnerHasBeenDeclared)
                {
                    raceStat4.FirstPosition = b.CarName;
                ...
                else if (!m_secondHasBeenDeclared)
                {
                    ...
                    raceStat4.SecondPosition = b.CarName;
                    raceStat4.SecondPositionTimer = b.m_raceTime;
                }
                else if (!m_thirdHasBeenDeclared)
                {
                    raceStat4.ThirdPosition = b.CarName;
                    raceStat4.ThirdPositionTimer = b.m_raceTime;
                }
                else if (!m_fourthHasBeenDeclared)
                {
                    raceStat4.FourthPosition = b.CarName;
